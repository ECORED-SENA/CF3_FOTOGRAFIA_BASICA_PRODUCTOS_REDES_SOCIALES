  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .d-flex.mb-5
      .title-edit-lvl1
        ...
        img(src="@/assets/curso/temas/tema7/img-3.svg" style="max-width: 83px")
    
    TabsA.color-acento-botones.mb-5.col-xl-9.mx-auto.py-5
      .tarjeta.color-acento-botones.d-flex.flex-wrap.flex-xl-nowrap(titulo="Paso 1" style="background-color: #FAF1BF; border-radius: 0")
        p.p-3.p-xl-4.mb-0.order-2.order-xl-1 <b>Paso 1</b>
          br
          | Desde el dispositivo móvil ubicar el icono de la aplicación, dar clic y aparecerá un menú en la parte superior al lado derecho de la pantalla, tal como se verá a continuación.
          br
          | Cada uno representa una acción, presionar sobre el icono + que se encuentra en la parte inferior, allí se desplegará un menú (PUBLICACIÓN, HISTORIA, REEL, VIDEO EN VIVO); se debe dar clic en publicación.
        img(src="@/assets/curso/temas/tema7/img-4.png" style="max-width: 295px").mx-auto.my-4.my-xl-0.order-1.order-xl-2
    ...
    .d-flex.mb-5
      .title-edit-lvl1
        h2 Cómo subir fotos a Instagram desde el PC
        img(src="@/assets/curso/temas/tema7/img-3.svg" style="max-width: 83px")
    
    p.mb-5 Además de cargar fotos desde el dispositivo móvil, también se pueden publicar fotos en Instagram desde el PC. Puede usar una extensión de Chrome llamada User-Agent-Switcher. Esta herramienta modifica el agente para que Instagram determine que la publicación se está cargando desde el móvil, de esta forma podrá darle entrada fácilmente la acción que se necesita.

    .d-flex.flex-wrap.mb-5
      ol.lista-ol--cuadro.lista-ol--separador.col-lg-6.order-2.order-lg-1
        li 
          .lista-ol--cuadro__vineta(style="background-color: #147DC4")
            span 1
          | Dar clic en el icono de la cámara +.
        li 
          .lista-ol--cuadro__vineta(style="background-color: #147DC4")
            span 2
          | Elegir dónde va a publicar la foto (añadir al perfil o a historias).
        li 
          .lista-ol--cuadro__vineta(style="background-color: #147DC4")
            span 3
          | Seleccionar la foto.
        ...
        li 
          .lista-ol--cuadro__vineta(style="background-color: #147DC4")
            span 5
          | Escribir el texto de pie de foto (esto si lo requiere).
        li 
          .lista-ol--cuadro__vineta(style="background-color: #147DC4")
            span 6
          | Etiquetar a gente (esto si lo requiere).
        li 
          .lista-ol--cuadro__vineta(style="background-color: #147DC4")
            span 7
          | Hacer clic en siguiente para publicar la foto.

      img(src="@/assets/curso/temas/tema7/img-9.svg" style="max-width: 423px").col-lg-6.mb-5.mb-lg-0.mx-auto.order-1.order-lg-2
    
    p.mb-5 Es un proceso sencillo y útil si se desea publicar de forma rápida una foto que se tenga en el ordenador, tal como se puede ver a continuación:
